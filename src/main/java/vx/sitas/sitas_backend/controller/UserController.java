...
import vx.sitas.sitas_backend.dto.StringReponse;
...
public class UserController {
    ...
    @GetMapping("/mee")
    public StringReponse test(@AuthenticationPrincipal DefaultOAuth2User principal) throws Exception{
        return new StringReponse("test");
    }
